...
In this guide, we will provide a step-by-step guide for migrating various Kafka application types, including Kafka API, KStreams, KTable, and python, to Pulsar. We will provide source code for the demos and provide tips and best practices along the way.
...
Step 2: Migrate your Kafka producers to Pulsar producers
Step 3: Migrate your Kafka consumers to Pulsar consumers
Source code for Kafka API demo
Migrating a KStreams application to Pulsar
